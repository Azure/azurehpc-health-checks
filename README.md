...
| check_ib_bw_loop_gdr | IB HCA device with GPU Direct RDMA(GDR) bandwidth | 180 GB/s | 180 GB/s | 380 GB/s | NA | NA |
...
| check_ib_bw | IB device (non GDR) bandwidth | NA | NA | NA | 390 GB/s | 390 GB/s |
