...
[![Build Status](https://dev.azure.com/hpc-platform-team/hpc-vm-health-check-framework/_apis/build/status/hpc-vm-health-check-framework?branchName=master)](https://dev.azure.com/hpc-platform-team/hpc-vm-health-check-framework/_build/latest?definitionId=29&branchName=master)

|          |Ubuntu 20.04 HPC|Ubuntu 22.04 HPC|Almalinux 8.7
|----------|------------|------------|------------|
|ND96asr_v4|[![Build Status](https://dev.azure.com/hpc-platform-team/hpc-vm-health-check-framework/_apis/build/status/hpc-vm-health-check-framework?branchName=master&jobName=Run_Health_Checks&configuration=Run_Health_Checks_On_VM%NDv4asr-ubuntu_20.04)](https://dev.azure.com/hpc-platform-team/hpc-vm-health-check-framework/_build/latest?definitionId=29&branchName=master)|[![Build Status](https://dev.azure.com/hpc-platform-team/hpc-vm-health-check-framework/_apis/build/status/hpc-vm-health-check-framework?branchName=master&jobName=Run_Health_Checks&configuration=Run_Health_Checks_On_VM%NDv4asr-ubuntu_22.04)](https://dev.azure.com/hpc-platform-team/hpc-vm-health-check-framework/_build/latest?definitionId=29&branchName=master)|[![Build Status](https://dev.azure.com/hpc-platform-team/hpc-vm-health-check-framework/_apis/build/status/hpc-vm-health-check-framework?branchName=master&jobName=Run_Health_Checks&configuration=Run_Health_Checks_On_VM%NDv4asr-alma8.7)](https://dev.azure.com/hpc-platform-team/hpc-vm-health-check-framework/_build/latest?definitionId=29&branchName=master)
|HB176rs_v4|[![Build Status](https://dev.azure.com/hpc-platform-team/hpc-vm-health-check-framework/_apis/build/status/hpc-vm-health-check-framework?branchName=master&jobName=Run_Health_Checks&configuration=Run_Health_Checks_On_VM%HBv4-ubuntu_20.04)](https://dev.azure.com/hpc-platform-team/hpc-vm-health-check-framework/_build/latest?definitionId=29&branchName=master)|[![Build Status](https://dev.azure.com/hpc-platform-team/hpc-vm-health-check-framework/_apis/build/status/hpc-vm-health-check-framework?branchName=master&jobName=Run_Health_Checks&configuration=Run_Health_Checks_On_VM%HBv4-ubuntu_22.04)](https://dev.azure.com/hpc-platform-team/hpc-vm-health-check-framework/_build/latest?definitionId=29&branchName=master)|[![Build Status](https://dev.azure.com/hpc-platform-team/hpc-vm-health-check-framework/_apis/build/status/hpc-vm-health-check-framework?branchName=master&jobName=Run_Health_Checks&configuration=Run_Health_Checks_On_VM%HBv4-alma8.7)](https://dev.azure.com/hpc-platform-team/hpc-vm-health-check-framework/_build/latest?definitionId=29&branchName=master)
